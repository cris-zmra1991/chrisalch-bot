...
if API_ID3 and API_HASH3 and STRING_SESSION3:
	...
	client3.add_event_handler(mobs_handler)
	client3.add_event_handler(bichos_palli_handler)
	client3.add_event_handler(check_melody_handler)
	client3.add_event_handler(quests_melody_handler)
	client3.add_event_handler(mobs_send_cheo_handler)
	client3.add_event_handler(reports_melody_handler)
	client3.add_event_handler(antorchas_handler)
	client3.add_event_handler(dados_handler)
	client3.add_event_handler(dados_hacks_handler)
	client3.add_event_handler(mel_afk_handler)
	client3.add_event_handler(trader_melody_handler)
	client3.add_event_handler(trader_melody_palli_handler)
	client3.add_event_handler(defensa_swamps_handler)
	client3.add_event_handler(defensa_valleys_handler)
	client3.add_event_handler(ares_handler)
...
if API_ID4 and API_HASH4 and STRING_SESSION4:
	...
	client4.add_event_handler(mobs_handler)
	client4.add_event_handler(bichos_palli_handler)
	client4.add_event_handler(check_melody_handler)
	client4.add_event_handler(quests_melody_handler)
	client4.add_event_handler(mobs_send_cheo_handler)
	client4.add_event_handler(reports_melody_handler)
	client4.add_event_handler(antorchas_handler)
	client4.add_event_handler(dados_handler)
	client4.add_event_handler(dados_hacks_handler)
	client4.add_event_handler(mel_afk_handler)
	client4.add_event_handler(trader_melody_handler)
	client4.add_event_handler(trader_melody_palli_handler)
	client4.add_event_handler(defensa_swamps_handler)
	client4.add_event_handler(defensa_valleys_handler)
	client4.add_event_handler(ares_handler)
